...
@section('content')
    <ol class="breadcrumb float-xl-end">
        <li class="breadcrumb-item"><a href="javascript:;">Perbaikan</a></li>
    </ol>
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            <a href="" class="btn btn-inverse mb-3 align-middle"><i class="fas fa-plus-circle"></i> Tambah Perbaikan</a>
