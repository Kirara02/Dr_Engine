...
@section('content')
    <ol class="breadcrumb float-xl-end">
        <li class="breadcrumb-item"><a href="javascript:;">Kerusakan</a></li>
    </ol>
    <h1 class="page-header">Data Kerusakan</h1>
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title">Data Kerusakan</h4>
        ...
        <div class="panel-body">
            <a href="" class="btn btn-inverse mb-3 align-middle"><i class="fas fa-plus-circle"></i> Tambah Kerusakan</a>
