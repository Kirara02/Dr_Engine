...
class LaporanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $perbaikan = Perbaikan::with(['detail','kerusakan','mekanik'])->where('tanggal', $date)
                    ->where('statusPembayaran','sudah bayar')->orderBy('tanggal', 'asc')->latest()->get();
        ...
        if ($request->tanggal) {
            ...
            $perbaikan = Perbaikan::with(['detail','kerusakan','mekanik'])
                        ->whereBetween('tanggal', [$mulai, $sampai])->orderBy('tanggal', 'asc')
                        ->where('statusPembayaran','sudah bayar')->latest()->get();
